<template>
    <div class="trutakemain" :class="{turnright:fanzhuanboolean}">
...
*{max-height: 100vh;touch-action: none}
...
.trutakemain{display: flex;overflow: hidden;}
.nonetake{
	position: fixed;
	left: 50%;
	top: 50%;
...
.foodcar3{display: flex;margin: 0.1rem 0 0 0;flex-shrink: -1;}
.foodcar3 ul{flex-shrink: -1;}
