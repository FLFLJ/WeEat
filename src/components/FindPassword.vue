<template>
    <div class="password_body">
        ...
        <div class="password_link">
            ...
            <router-link to="/my/register">立即注册</router-link>
        </div>
    </div>
</template>
...
.password_body .password_text{width:100%;height: 40px;border: none;border-bottom: 1px #ccc solid;margin-bottom: 5px;outline-color: none;}
.password_body .password_btn{height: 50px;margin: 10px;}
.password_body .password_email{position: relative;}
.password_body .password_email button{position:absolute;top:25px; right: 10px; border-radius: 3px;border:none;padding: 5px;height: 30px;}
