<template>
    <div class="register_body">
        ...
        <div class="register_link">
            <router-link to="/my/login">立即登录</router-link>
            <router-link to="/my/findpassword">找回密码</router-link>
        </div>
    </div>
</template>
...
.register_body .register_text{width:100%;height: 40px;border: none;border-bottom: 1px #ccc solid;margin-bottom: 5px;outline-color: none;}
.register_body .register_btn{height: 50px;margin: 10px;}
.register_body .register_email{position: relative;}
.register_body .register_email button{position:absolute;top:25px; right: 10px; border-radius: 3px;border:none;padding: 5px;height: 30px;}
